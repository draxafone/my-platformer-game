...
class app():
    def __init__(self):
        ...
        self.text = ttk.Label(self.mainframe, text='mikkel er kul', background='white', font=("brass mono", 20))
        ...
        color_options = ('red', 'blue', 'green', 'black', 'orange', 'pink', 'purple', 'yellow')
    ...
    def reverse(self):
        ...
        reversed_text = newtext[::-1]
        self.text.config(text=reversed_text)
